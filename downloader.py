...
HCC Sermon Transcripts GitHub repository.
"""
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "HCC-Sermon-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "HCC-Sermon-Transcripts"
...
if __name__ == "__main__":
    url = "https://github.com/willtheorangeguy/HCC-Sermon-Transcripts/archive/refs/heads/main.zip"
    output_zip = "HCC_sermon_transcripts.zip"
